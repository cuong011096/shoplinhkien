...
namespace WebLinhkien.Areas.admin.Controllers
{
    ...
    public class AccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Usernames,Passwords,NameUser,Gender,Tel,Addresss,email,ResetPasswordCode,IDRole")] Accounts accounts)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Usernames,Passwords,NameUser,Gender,Tel,Addresss,email,ResetPasswordCode,IDRole")] Accounts accounts)
        {
            if (ModelState.IsValid)
            {
                accounts.createsdate = DateTime.Now;
